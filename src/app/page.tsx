    ...
    <div className="flex w-full h-full justify-center items-center px-4 my-8">
      <div className="flex flex-col w-full h-full items-center justify-center gap-4 max-w-[800px] text-center">
        <div className="animated-spin">
          <Image
            src={"/disc.png"}
            alt="Vangelis´ China Disc"
            width={160}
            height={160}
          />
        </div>
        <h1 className="font-bold text-3xl my-4">Vangelis Quiz</h1>
        <p>
          This quiz has been created to celebrate Vangelis´ music. The questions
          span his career from his early works to his last compositions. We hope
          that both the occasional listeners and the long-time fans will find it
          appealing.
        </p>
        <p>
          ...
          selected 10 questions. There is one correct answer to each question.
        </p>
        <p>© Zoltan Horvath and his son, Adam</p>
